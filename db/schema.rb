...
ActiveRecord::Schema[7.1].define(version: 2026_08_22_200000) do
  ...
  create_table "tournaments", force: :cascade do |t|
    ...
    t.string "labs_tournament_id"
    t.index ["game_id"], name: "index_tournaments_on_game_id"
    t.index ["labs_tournament_id"], name: "index_tournaments_on_labs_tournament_id", unique: true
  end
