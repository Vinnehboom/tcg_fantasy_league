...
ActiveRecord::Schema[7.1].define(version: 2026_09_15_090000) do
  ...
  create_table "data_subject_requests", force: :cascade do |t|
    ...
    t.index ["player_id"], name: "index_data_subject_requests_on_player_id"
  ...
  create_table "external_scores", force: :cascade do |t|
    ...
    t.index ["player_season_id"], name: "index_external_scores_on_player_season_id"
  end
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.index ["suppressed_at"], name: "index_players_on_suppressed_at"
  end
  ...
  create_table "score_modifiers", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.datetime "discarded_at"
    t.index ["discarded_at"], name: "index_score_modifiers_on_discarded_at"
  end
  ...
  create_table "settings", force: :cascade do |t|
    ...
    t.string "settingable_id", null: false
  ...
  create_table "tournaments", force: :cascade do |t|
    ...
    t.string "results_source_id"
    t.index ["game_id"], name: "index_tournaments_on_game_id"
    t.index ["results_source_id"], name: "index_tournaments_on_results_source_id", unique: true
  end
  ...
  add_foreign_key "data_subject_requests", "players"
