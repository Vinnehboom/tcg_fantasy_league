...
Between Checkpoints 2 and 3 the developer and reviewer run to completion (including review→fix loops) without further prompts, unless the reviewer escalates. (Tester/Phase 4 is currently disabled — see Phase 4 — so it isn't part of this stretch right now.)
