    ...
    describe '#average' do
      ...
      context 'when scores come from more than one game' do
        it 'only reflects scores from the requested game' do
          ...
          create(:external_score, player:, season: '2026', score: 10)
          create(:external_score, player: other_player, season: '2026', score: 90)
    ...
    describe '#median' do
      context 'with an odd-sized population' do
        it 'returns the middle score, as a Float' do
          ...
          create(:external_score, player: players[0], season: '2026', score: 90)
          create(:external_score, player: players[1], season: '2026', score: 10)
          create(:external_score, player: players[2], season: '2026', score: 20)
      ...
      context 'with an even-sized population' do
        it 'returns the mean of the two middle scores' do
          ...
          create(:external_score, player: players[0], season: '2026', score: 90)
          create(:external_score, player: players[1], season: '2026', score: 31)
          create(:external_score, player: players[2], season: '2026', score: 10)
          create(:external_score, player: players[3], season: '2026', score: 20)
