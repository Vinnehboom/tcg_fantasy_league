...
module Admin
  ...
  module Api
    ...
    RSpec.describe 'PlayerSeasonModifiers' do
      ...
      describe '#create' do
        ...
        it 'gives the modifier to the player for that season' do
          post(admin_api_player_season_modifiers_path, params:)
      ...
      describe '#destroy' do
        ...
        it 'takes the modifier away from the player for that season' do
          delete admin_api_player_season_modifier_path(player_season_modifier)
